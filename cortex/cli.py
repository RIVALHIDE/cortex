...
class CortexCLI:
    ...
    def role(self, args: argparse.Namespace) -> int:
        ...
        Note: Role management feature is not available in this version.
        """
        self._print_error("Role management feature is not available in this version.")
        return 1
    ...
    def remove(self, args: argparse.Namespace) -> int:
        ...
        Note: Uninstall impact analysis feature is not available in this version.
        """
        self._print_error("Uninstall impact analysis feature is not available in this version.")
        cx_print("Use 'sudo apt-get remove <package>' directly for package removal.", "info")
        return 1
